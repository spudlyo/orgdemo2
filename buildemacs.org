...
In this section I'll demonstrate how you ca
...
Now that we've cloned the repository, let's =cd= into the directory and take a look at some tags. Emacs uses =git= tags
to capture a point in the commit history that marks the release of a specific version. 
...
#+begin_src bash
  ...
  #+RESULTS[bff0bbcb583233629cc6dabd0d6296379d4f1cc8]:
  #+begin_example
  183
  #+end_example
