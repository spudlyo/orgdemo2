...
#+RESULTS[9ad8416d923624d8c4e12a96d06af904c4b71b6d]:
...
** Checking out the tags
:PROPERTIES:
:header-args:bash+:  :dir ~/src/emacs
:END:
...
Wow {{{r(num_tags)}}} tags is a lot! We can narrow it down a bit by listing just the tags for Emacs 29.

#+begin_src bash
git tag --list 'emacs-29*'
#+end_src

#+RESULTS[e5b10d46029cda3035fa5bab7099bb6a3bd87420]:
#+begin_example
emacs-29
emacs-29.0.90
emacs-29.0.91
