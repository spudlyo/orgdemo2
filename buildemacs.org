...
There is a script called =autogen.sh= that does this work for you. Let's run the script, and take a look at the first
...
#+RESULTS[4eb6833f6c77e0afe58ed4310ebc75d21f25d37a]: autogen
#+begin_example
...
It looks like we're going to need to install =autoconf= before this is going to work for us. This should be easy enough
to do.

#+begin_src bash
  <<get_prop("install")>> autoconf
#+end_src
